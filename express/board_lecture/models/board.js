...
const board = {
  ...
  async getList(boardId, page, limit) {
    ...
    page = page || 1;
    limit = limit || conf.listPerPage;
    // 설정 - 1페이지당 게시글 수
    const offset = (page - 1) * limit;

    const sql = `Select * From boardData a Left Join member b on a.memNo = b.memNo Where a.boardId = :boardId Order By a.regDt Desc Limit :offset, :limit`;
